...

{
  ...
  class Cart {
    ...
    remove(cartProduct) {
      ...
      const removedProductArray = thisCart.products.splice(cartProduct, 1);
      console.log(removedProductArray);

      const removedProduct = thisCart.dom.productList.cartProduct;
